        ...
        items: [
          {
            ...
            items: [
              {
                label: '¿Qué Flexbox?',
                slug: 'css/flex/01-que-es-flex'
              },
              {
                label: 'Flexbox por defecto',
                slug: 'css/flex/02-flex-por-defecto'
              },
              {
                label: 'Flex direction',
                slug: 'css/flex/03-flex-direction'
              },
              {
                label: 'Flex wrap y Flex flow',
                slug: 'css/flex/04-flex-wrap-flex-flow'
              },
              {
                label: 'Justify content',
                slug: 'css/flex/05-flex-justify-content'
              },
              {
                label: 'Align items',
                slug: 'css/flex/06-flex-align-items'
              },
              {
                label: 'Align content',
                slug: 'css/flex/07-flex-align-content'
              },
              {
                label: 'Row gap y Column gap y gap',
                slug: 'css/flex/08-flex-row-gap-columngap-gap'
              },
              {
                label: 'Flex grow',
                slug: 'css/flex/09-flex-grow'
              },
              {
                label: 'Flex shrink',
                slug: 'css/flex/10-flex-shrink'
              },
              {
                label: 'Flex basis',
                slug: 'css/flex/11-flex-basis'
              },
              {
                label: 'Order',
                slug: 'css/flex/12-flex-order'
              },
              {
                label: 'Align self',
                slug: 'css/flex/13-flex-align-self'
              }
            ]
          }
        ]
  ...
  // "Tab" JavaScript
  {
    ...
    items: [
      ...
      { label: '¿Tipos de datos?', slug: 'js/tipos-de-datos' },
      {
        ...
        collapsed: true,
        items: [
          { label: 'Arrays en JavaScript', slug: 'js/arrays' },
          {
            label: 'Métodos y propiedades de Array',
            slug: 'js/array/metodos-propiedades-array'
          },
          { label: 'Iteración de Arrays', slug: 'js/array/iteracion-arrays' },
          { label: 'Busqueda en Arrays', slug: 'js/array/busqueda-metodos' },
          { label: 'Ordenación de Arrays', slug: 'js/array/ordenacion-arrays' },
          {
      ...
      },
      {
        ...
        collapsed: true,
        items: [
          { label: 'Objetos en JavaScript', slug: 'js/objetos/objetos' },
          {
            label: 'Desestructuración de objetos',
            slug: 'js/objetos/desestructuracion-objetos'
          },
          { label: 'Iteración de objetos', slug: 'js/objetos/iterar-objetos' }
        ]
      },
      {
        label: 'Ejercicios',
    ...
    items: [
      {
        ...
        items: [
          ...
          {
            label: '1.5 Diseño Accesible desde el Principio (Design Thinking)',
      ...
      },
      {
        ...
        items: [
          ...
          { label: '7.2 NVDA (Windows)', slug: 'accesibilidad/section-7/7_2' },
          {
